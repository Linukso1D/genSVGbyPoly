...
public class Workarea implements Cloneable, Serializable {
	...
	public String toSvg() {
		...
		String header = "<?xml version=\"1.0\" encoding=\"iso-8859-1\"?>\n" +
				"<svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" height=\"" + Draw().getHeight() + "\" width=\"" + Draw().getWidth() + "\">";
		ArrayList<String> poly = new ArrayList<>();
		Polygons.forEach((Polygon p) -> poly.add(p.toSvg()));
		String footer = "</svg>";
		svg += header;
